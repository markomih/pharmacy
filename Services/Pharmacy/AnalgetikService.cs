...
namespace Services
{
    public class AnalgetikService : Service<Analgetik>, IAnalgetikService
    {
        ...
        public override void Create(Analgetik entity)
        {
            ServiceProvider.Get<LekService>().Create(entity);
        }

        public override void Update(Analgetik entity)
        {
            ServiceProvider.Get<LekService>().Update(entity);
        }

        public override void Update(int id, Analgetik entity)
        {
        ...
        public override void Delete(int id)
        {
            using (var session = DataLayer.GetSession())
            {
                try
                {
                    var entity = session.Get<Analgetik>(id);
